...
// Bleu mesuré sur l'objet réel : RGB(22,51,93) → HSV(215°,76%,36%)
// En OpenCV : H=107 (215/2), S=194 (76%×255), V=92 (36%×255)
// Plage élargie pour tolérer les variations d'éclairage :
//   Hue  : ±12 autour de 107 → [95, 119]
//   Sat  : min 55 (objet en ombre), pas de min élevé car S est forte
//   Value: min 15 (objet sombre), max 160 (évite les reflets trop clairs)
static const Scalar LOWER_BLUE(95,  55, 15);
static const Scalar UPPER_BLUE(119, 255, 160);
